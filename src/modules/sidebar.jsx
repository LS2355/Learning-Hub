  ...
  return (
      <nav className="w-20 bg-navbar h-screen hidden sm:grid md:w-24 place-items-center sticky top-0">
          ...
          <div className="w-full h-1/2 flex justify-end flex-col items-center">
            ...
            <NavLink to={"./settings"} className="w-10/12 bg-cardbg  text-subtext grid place-items-center aspect-square hover:bg-hoveredGrey hover:text-focused rounded-lg mb-3 transition-all hover:scale-105">
              {/* settings */}
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
