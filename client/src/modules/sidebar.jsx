      ...
      <nav className="w-20 bg-navbar h-screen hidden sm:grid md:w-24 place-items-center sticky top-0 border-r-2 border-hoveredGrey ">
          ...
          <div className="w-full h-1/2 flex justify-end flex-col items-center">
            ...
            >
              ...
              <a href="https://github.com/LS2355/learning-hub"  target="_blank" rel="noreferrer" className="w-10/12 bg-cardbg hover:text-focused text-subtext grid place-items-center aspect-square hover:bg-hoveredGrey hover:text-focused rounded-lg mb-3 transition-all hover:scale-105">
